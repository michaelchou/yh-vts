...
//------------------ 样式定义 ---------------------------//
//功能按钮同样样式
var s_tiannet_turn_base = "height:30px;font-size:19pt;color:white;border:0 solid #CCCCCC;cursor:hand;background-color:#2650A6;";
//翻年、月等的按钮
var s_tiannet_turn = "width:68px;" + s_tiannet_turn_base;
//关闭、清空等按钮样式
var s_tiannet_turn2 = "width:68px;" + s_tiannet_turn_base;
//年选择下拉框
var s_tiannet_select = "width:76px;font-size:15px;display:none;";//modify 2007-08-29
//月、时、分选择下拉框
var s_tiannet_select2 = "width:42px;display:none;";//加秒 modify 2007-08-29
//日期选择控件体的样式
var s_tiannet_body = "width:300px;background-color:#2650A6;display:none;z-index:9998;position:absolute;" +//modify 2007-08-29
  "border-left:1 solid #CCCCCC;border-top:1 solid #CCCCCC;border-right:1 solid #999999;border-bottom:1 solid #999999;";
//显示日的td的样式
var s_tiannet_day = "width:42px;height:40px;background-color:#D8F0FC;font-size:20px;";
//字体样式
var s_tiannet_font = "color:#FFCC00;font-size:19px;cursor:hand;";
//链接的样式
var s_tiannet_link = "text-decoration:none;font-size:19px;color:#2650A6;";
//当前的时间
var myDate = new Date();
//横线
...
var tiannetHour =myDate.getHours();//tiannetDateNow.getHours();
var tiannetMinute =myDate.getMinutes();//tiannetDateNow.getMinutes(); modify 2007-08-29
var tiannetSecond =myDate.getSeconds();//add 2007-08-29
...
var m_bolShowSecond = false;//是否显示秒 add 2007-08-29
...
//用户主调函数－选择日期、小时、分钟及秒 add 2007-08-29
...
document.write('<select id="selTianSecond" style="'+s_tiannet_select2+'display:none;" Author="tiannet" '+
    '  onChange="tiannetSecond=this.value;tiannetWriteHead();document.all.tiannetSecondHead.style.display=\'\';'+
    'this.style.display=\'none\';">');
for(var i=0;i <= 59;i ++){
...
for(var i =0;i < weekName.length;i ++){
 //输出星期
 document.write('<td width="41px" align="center" Author="tiannet">' + weekName[i] + '</td>');
}
document.write(' </tr>');
...
function spanYearCEvent(){
 ...
 if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);//add 2007-08-29
 hideElementsById(new Array("tiannetYearHead","selTianMonth","selTianHour","selTianMinute","selTianSecond"),true);//modify 2007-08-29
}
//单击月份span标签响应
function spanMonthCEvent(){
 ...
 if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false);
 if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);//add 2007-08-29
 hideElementsById(new Array("tiannetMonthHead","selTianYear","selTianHour","selTianMinute","selTianSecond"),true);//modify 2007-08-29
}
//单击小时span标签响应
function spanHourCEvent(){
 ...
 if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false);
 if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);//add 2007-08-29
 hideElementsById(new Array("tiannetHourHead","selTianYear","selTianMonth","selTianMinute","selTianSecond"),true);//modify 2007-08-29
}
//单击分钟span标签响应
function spanMinuteCEvent(){
 ...
 if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);//add 2007-08-29
 hideElementsById(new Array("tiannetMinuteHead","selTianYear","selTianMonth","selTianHour","selTianSecond"),true);//modify 2007-08-29
}
//单击秒span标签响应 add 2007-08-29
...
function tiannetWriteHead(){
 ...
 if( m_bolShowSecond ) document.all.tiannetSecondHead.innerText = tiannetSecond + "秒";//add 2007-08-29
...
function selectObject(){
 ...
 if( m_bolShowSecond ) checkSelect(document.all.selTianSecond,tiannetSecond);//add 2007-8-30
}
//给接受日期时间的控件赋值
...
function showTime(){
 ...
 //add 2007-08-29
 if( m_bolShowSecond && (!m_bolShowHour || !m_bolShowMinute)){
  alert("如果要选择秒，则必须可以选择小时和分钟！");
  return;
 }
 hideElementsById(new Array("tiannetHourHead","selTianHour","tiannetMinuteHead","selTianMinute","tiannetSecondHead","selTianSecond"),true);//modify 2007-08-29
 if( m_bolShowHour ){
  //显示小时
...
function tiannetPopCalendar(){
 //隐藏下拉框，显示相对应的head
 hideElementsById(new Array("selTianYear","selTianMonth","selTianHour","selTianMinute","selTianSecond"),true);//modify 2007-08-29
 hideElementsById(new Array("tiannetYearHead","tiannetMonthHead","tiannetHourHead","tiannetMinuteHead","tiannetSecondHead"),false);//modify 2007-08-29
 tiannetSetDay(tiannetYear,tiannetMonth);
 tiannetWriteHead();
 showTime();
