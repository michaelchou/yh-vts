...
public class Processor_CDSUnitQuery extends Processor {

	public Processor_CDSUnitQuery() {
		super();
	}
	...
	public void process() throws ProcessorException {
		...
		if(cdsUnitList != null && cdsUnitList.size() > 0){
			...
			throw new ProcessorException(TERMRETCODE_CDSUNITQUERY,TERMRETDESC_CDSUNITQUERY, TERMRETDESCEN_CDSUNITQUERY);
		}
