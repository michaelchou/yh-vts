 ...
 *
 */
public class TransLogWithdrawal {
	...
	private int itermTransStatus;  //终端交易状态 0:未动作  1:已送钞    2:出钞失败 3:结果不确定
	...
	private int iReverSeenTryStatus;//是否冲正  0不冲正  1冲正成功  2冲正失败  3结果不确定
	...
	public int getiReverSeenTryStatus() {
		return iReverSeenTryStatus;
	}
	public void setiReverSeenTryStatus(int iReverSeenTryStatus) {
		this.iReverSeenTryStatus = iReverSeenTryStatus;
	}	
}
