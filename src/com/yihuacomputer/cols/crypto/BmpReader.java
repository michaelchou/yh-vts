...
public class BmpReader
{
    ...
    public static void bmpTojpg(String file,String dstFile)
    {
        try
        {
            ...
            Image TheImage = ImageIO.read(imgFile);

            BufferedImage tag = new BufferedImage(TheImage.getWidth(null), TheImage.getHeight(null), BufferedImage.TYPE_INT_RGB);
            tag.getGraphics().drawImage(TheImage, 0, 0, 152, 200, null);
    ...
    {
        String srcfile = "c://Finger.bmp";
        String dstFile = "c://Finger.jpg";
